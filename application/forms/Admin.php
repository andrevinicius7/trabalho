...
class Application_Form_Admin extends Zend_Form {
    ...
    public function init() {
        ...
        $this->addElement($idadmin);
               ...
               $nome = new Zend_Form_Element_Text('nome', array('label' => 'NOME COMPLETO','required' => true,));
        $this->addElement($nome);

        $this->emailNaoRepetidoVal = new Zend_Validate_Db_NoRecordExists(array('table' => 'admin','field' => 'email'));

        $email = new Zend_Form_Element_Text('email', array('label' => 'ENDERECO DE EMAIL','required' => true,));
        ...
        $papel = new Zend_Form_Element_Select('papel', array('label' => 'PAPEL','required' => true,));
